  ...
  return (
    <div className={styles.container}>
      ...
      <p>
        ...
        dramas to the action-packed adventures, there's something for everyone
        to enjoy.
      </p>
      ...
      <p>
        ...
        titles. Whether you're a long-time fan or a curious newcomer, we've got
        you covered with reviews, analysis, and deep dives into the stories,
        characters, and themes that make anime so captivating.
      </p>
      <br />
      <p>
      ...
      <br />
      <p>
        But we don't just stop at the classics - we also delve into newer series
        that are sure to become future favorites. From the sci-fi adventures of
        Steins;Gate to the supernatural thrills of Jujutsu Kaisen, we keep our
        fingers on the pulse of the anime world and bring you the latest and
        greatest shows.
      </p>
      <br />
      <p>
        ...
        inspire, and we're passionate about sharing that message with the world.
      </p>
      <br />
      <p>
        So, whether you're a seasoned otaku or just dipping your toes into the
        anime waters, we invite you to join us on this amazing journey through
        the world of anime. Get ready to immerse yourself in epic battles,
        explore new worlds, and fall in love with unforgettable characters – all
